          ...
          <div className="">
            {wishlist && wishlist.length === 0 ? (
              <div className="h-screen flex-col items-center  justify-center text-center mt-28">
               <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSa1RMwfNJRNY-qvsR8L2_p8Zuar8jRwW2zA0Abzx1FyQ&s" alt="" />
                <h5 className="text-red-400 mt-10 text-xl font-semibold">wishlist Items is empty !</h5>
              </div>
            ) : (
              <>
                <div>
                  ...
                  {/* Item length */}
                  <div className={`${commonStyles.noramlFlex} items-center py-2`}>
